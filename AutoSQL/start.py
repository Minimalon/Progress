                    ...
                    with open("/root/ttnload/TTN/" + TTN + "/WayBill_v4.xml") as f:
                        for line in f:
                            ...
                            if "<wb:EAN13>" in line:
                                ...
                                insert1 = "INSERT IGNORE INTO tmc (bcode, vatcode1, vatcode2, vatcode3, vatcode4, vatcode5, dcode, name, articul, cquant, measure, pricetype, price, minprice, valcode, quantdefault, quantlimit, ostat, links, quant_mode, bcode_mode, op_mode, dept_mode, price_mode, tara_flag, tara_mode, tara_default, unit_weight, code, aspectschemecode, aspectvaluesetcode, aspectusecase, aspectselectionrule, extendetoptions, groupcode, remain, remaindate, documentquantlimit, age, alcoholpercent, inn, kpp, alctypecode, manufacturercountrycode, paymentobject, loyaltymode, minretailprice) VALUES ('"+ EAN +"',301,302,303,304,305,1,'"+ ShortName + " " + Capacity + "л""','',1.000,2114,0,0.00,"+ price.split(".")[0] +".00,0,1.000,0.000,0,0,15,3,192,1,1,NULL,NULL,'0',NULL,'"+ ShortName + " " + Capacity + "л""',NULL,NULL,NULL,NULL,NULL,NULL,0.000,NULL,2.000,NULL,15.00,NULL,NULL,0,NULL,NULL,0,0.00)"
                                insert2 = "INSERT IGNORE INTO barcodes (code, barcode, name, price, cquant, measure, aspectvaluesetcode, quantdefault, packingmeasure, packingprice, minprice, minretailprice, customsdeclarationnumber, tmctype) VALUES ('" + EAN + "','" + EAN + "','" + ShortName + " " + Capacity + "л""'," + price.split(".")[0] + ",NULL,2,NULL,1.000,2,NULL,0.00,NULL,NULL,NULL)"
